...
5. Move the idle-video.service file to ~/.config/systemd/user/idle-video.service. Modify the path in the script to the location of the idle-video.sh script.
